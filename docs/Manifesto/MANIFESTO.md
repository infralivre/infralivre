# Manifesto pela Infraestrutura Digital Livre, Aberta e Segura
...
Essa diferença não é um detalhe. É uma ruptura estrutural.

E essa ruptura não está sendo reconhecida.
...
Está sendo atribuída responsabilidade a quem não possui controle técnico sobre o uso do software.

Isso expõe mantenedores, contribuidores e distribuidores a riscos que não correspondem à sua atuação real.
...
Esse cenário pode levar a um efeito sistêmico.

Não um colapso imediato, mas um travamento gradual, silencioso e profundo da infraestrutura digital.

Um ambiente onde:

* o uso continua, mas sem segurança jurídica
* a transparência é substituída por omissão
* decisões técnicas passam a ser guiadas pelo medo jurídico
...
O software livre deve ser reconhecido como:

infraestrutura digital aberta de interesse público
...
* critérios de imputação jurídica
* distinção entre criação e uso

---

### 6.2 Reconhecimento da descentralização

Garantir proteção para projetos:

* sem entidade jurídica central
* compostos por múltiplos contribuidores

---

### 6.3 Proteção ao voluntariado tecnológico

Assegurar que contribuições:

* não configurem vínculo empregatício
* não gerem obrigações indevidas

---

### 6.4 Princípio da impossibilidade técnica

Impedir a imposição de obrigações que não podem ser cumpridas pela própria natureza do software livre.

---

### 6.5 Separação entre desenvolvimento e operação
...
### 6.6 Sustentabilidade do ecossistema

Criar condições reais para:

* manutenção de projetos
* financiamento
* fortalecimento do desenvolvimento nacional

---

## 7. O custo de ignorar o problema

A ausência de um marco jurídico adequado não mantém o status atual.

Ela agrava o problema.
...
A base sobre a qual a economia digital opera passa a existir em um estado de incerteza contínua.
...
Este manifesto não propõe ausência de regras.

Propõe regras adequadas.

Regras que reconheçam:

* a realidade técnica
* a natureza coletiva
* os limites do controle no software livre
...
a reconhecer a gravidade da situação e a participar da construção de uma solução.

---

## 10. Conclusão

O software livre sustenta silenciosamente grande parte do mundo digital.

Sua fragilização jurídica não será imediatamente visível.

Mas seus efeitos serão profundos.

Permitir que essa base opere em insegurança é aceitar um risco sistêmico desnecessário.

Garantir sua proteção jurídica não é uma escolha ideológica.

É uma necessidade estrutural.

O momento de agir não é no futuro.
