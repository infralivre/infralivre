<script lang="ts">
	...
	import ProposalSummary from '$lib/content/proposal-summary.md';
...
<Section class="pb-8">
	<div class="mx-auto max-w-3xl text-center">	
		...
		<div class="mx-auto mt-10 flex max-w-fit items-center rounded-full border border-zinc-200 bg-zinc-100/50 p-1.5 shadow-inner dark:border-zinc-800 dark:bg-zinc-900/50">
			...
			>
				<FileText class="size-4 transition-transform group-hover:scale-110 group-hover:text-emerald-600 dark:group-hover:text-emerald-400" />
				Proposta Completa
			</a>
			<a 
...
<div class="mx-auto flex max-w-3xl justify-center px-4 pb-8">
	<ShareButtons title="A Proposta (Resumo)" description="Segurança jurídica e proteção aos mantenedores — sem amarras corporativas." />
</div>
