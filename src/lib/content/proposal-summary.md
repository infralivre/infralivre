...
- Definição legal das cinco camadas: software livre, hardware aberto, serviços abertos, redes livres e dados abertos (incluindo modelos abertos de IA, tratados como dados)
...
- **Direito de uso justo de dados para infraestrutura livre**: projetos abertos podem utilizar dados publicamente disponíveis — incluindo dados protegidos — para aprendizado, treinamento de IA, análise e transformação, desde que o resultado não substitua a obra original e seja publicado sob licença livre. Presunção de uso justo com inversão do ônus. Exclusivo para projetos abertos — quem fecha o resultado opera sob regime comum
...
- **Empresa de Infraestrutura Livre**: selo de acesso ao regime tributário diferenciado — exige **100% dos produtos e serviços** como infraestrutura livre (serviços acessórios como suporte, consultoria e treinamento são admitidos). Inclui software, hardware, dados, modelos de IA e serviços operados sob licenças livres. Par CNPJ-custodiante + CNPJs-PIL. Revogável
...
- **Agência Nacional da Infraestrutura Livre (ANIL)**: autarquia federal de natureza especial sem vinculação ministerial (modelo Banco Central após LC 179/2021). **Conselho Deliberativo de 24 membros** em estrutura bicameral com tripé de legitimidades: Câmara Institucional (12 — 6 indicados pelo Presidente com aprovação do Senado + 6 indicados por entidades técnicas: 3 pela SBC e 3 pelo CGI.br; mandato 9 anos vedada recondução) e Câmara da Sociedade Civil (12 — eleitos pelo ecossistema em 3 áreas de 4 vagas: empresarial, acadêmica e cidadã; mandato 3 anos com recondução). 6 via política + 6 via técnica + 12 via democrática. Deliberações exigem **maioria simples em cada câmara**
- **Diretoria Executiva de 6 membros**, eleita pelo Conselho: 5 diretores temáticos (software, hardware, redes, dados, serviços) + Presidente da ANIL — mandato de 3 anos, permitida uma recondução. Autonomia financeira com receita própria, poder sancionatório
- **Competências da ANIL**: registro e supervisão de PILs; registro de marcas, patentes livres e licenças (autoridade concorrente ao INPI); qualificação de Empresas de Infraestrutura Livre; fiscalização e enforcement; regulamentação técnica; gestão do Fundo Nacional de Infraestrutura Livre
- **Especialização do Judiciário e do MP**: varas federais e estaduais especializadas em infraestrutura livre, grupo especializado no MPF, promotorias estaduais, Defensoria Pública especializada para mantenedores sem recursos
- **Formação continuada**: infraestrutura livre como disciplina obrigatória em concursos para magistratura, MP, Defensoria Pública e AGU

## Alcance

| Pilar | Problema | Efeito |
|-------|----------|--------|
| 1. Reconhecimento | Incerteza jurídica | Define, nomeia, categoriza |
| 2. Separação funcional | Responsabilização indevida | Vincula responsabilidade a controle |
| 3. Compatibilidade | Obrigações impossíveis | Blinda contra regulação inexequível |
| 4. Proporcionalidade | Barreiras operacionais | Remove discriminação estrutural |
| 5. Sustentabilidade | Fragilidade econômica | Cria condições para prosperar |
| 6. Institucionalização | Efetividade do Marco | Garante enforcement com estrutura dedicada |
